...
public class SimpleParser {
	...
	Kind[] firstStatement = {KW_input, KW_write, KW_while, KW_if, KW_show, KW_sleep, IDENTIFIER, KW_red, KW_green, KW_blue, KW_alpha };

	Kind[] firstExpression = {OP_PLUS, OP_MINUS, OP_EXCLAMATION, 
			INTEGER_LITERAL, BOOLEAN_LITERAL, FLOAT_LITERAL, LPAREN, IDENTIFIER, LPIXEL,  
			KW_abs, KW_sin, KW_cos, KW_atan, KW_log, KW_cart_x, KW_cart_y, KW_polar_a, KW_polar_r, KW_int, KW_float, KW_width, KW_height, 
			KW_red, KW_green, KW_blue, KW_alpha,
			KW_Z, KW_default_width, KW_default_height };
	
	Kind[] firstFunctionName = {KW_sin, KW_cos, KW_atan, KW_log, KW_cart_x, KW_cart_y, KW_polar_a, KW_polar_r, KW_int, KW_float, KW_width, KW_height,
			KW_red, KW_green, KW_blue, KW_alpha};
	...
	/*
	 * Declaration ::=  image Identifier ( epsilon | [Expression, Expression] | Type Identifier
	 */
	...
	public void statement() throws SyntaxException {
		switch(t.kind) {
			...
			case IDENTIFIER :
			case KW_red : case KW_green : case KW_blue : case KW_alpha : {
	 ...
	 *			  FunctionApplication  |​ IDENTIFIER (epsilon ​| PixelSelector) | PredefinedName | PixelConstructor
	 */
